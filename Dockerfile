...
RUN apt-get update && apt-get install -y --no-install-recommends libfontconfig1 libharfbuzz0b libfreetype6 libjpeg-turbo8 libpng16-16 libtiff6 libwebp7 libgif7 fonts-dejavu-core && rm -rf /var/lib/apt/lists/*
WORKDIR /app
